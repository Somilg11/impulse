...
export default function DocsPage() {
  const sections = [
    {
      ...
      content: (
        <>
          <p className="text-[15px] leading-[1.75] text-zinc-400 mb-7">
      ...
      content: (
        <>
          <p className="text-[15px] leading-[1.75] text-zinc-400 mb-7">
            ...
            <code className="rounded bg-white/[0.07] px-1.5 py-0.5 font-mono text-[13px] text-brand">/workspace</code>{" "}
            to start sending requests.
          </p>
          <div className="rounded-xl border border-hairline bg-black/50 p-6 font-mono text-[13px] leading-relaxed mb-8">
            <div className="flex items-center gap-1.5 mb-4 border-b border-hairline pb-3">
              <div className="w-2 h-2 rounded-full bg-red-500/50" />
              <div className="w-2 h-2 rounded-full bg-yellow-500/50" />
              <div className="w-2 h-2 rounded-full bg-green-500/50" />
            </div>
            <div className="text-brand"># 1. Sign in</div>
            ...
            <div className="text-brand mt-3"># 2. Open the workspace</div>
            <div className="text-zinc-500">
              Visit{" "}
              <Link href="/workspace" className="text-brand hover:underline">
                /workspace
              </Link>
            </div>
            <div className="text-brand mt-3"># 3. Send a request</div>
            <div className="text-zinc-500">
              Type a URL in the bar and press Send &mdash; no saving required
            </div>
            <div className="text-brand mt-3"># 4. Keep it</div>
            <div className="text-zinc-500">
              Create a collection in the sidebar, then save the request into it
            </div>
          </div>
          <div className="rounded-xl border border-hairline bg-white/[0.03] p-5 mb-8">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex items-center justify-between">
                ...
                <code className="rounded bg-white/[0.07] px-1.5 py-0.5 font-mono text-[12px] text-brand">
                  Ctrl/&#8984; + G
                </code>
              </div>
              <div className="flex items-center justify-between">
          ...
          <div className="rounded-xl border border-hairline bg-white/[0.03] p-5 mb-8">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex items-start gap-3">
                <code className="rounded bg-white/[0.07] px-1.5 py-0.5 font-mono text-[12px] text-method-patch shrink-0">
                  ADMIN
                </code>
              ...
              <div className="flex items-start gap-3">
                <code className="rounded bg-white/[0.07] px-1.5 py-0.5 font-mono text-[12px] text-brand shrink-0">
                  EDITOR
                </code>
                <span className="text-zinc-500 text-xs">
              ...
              <div className="flex items-start gap-3">
                <code className="rounded bg-white/[0.07] px-1.5 py-0.5 font-mono text-[12px] text-zinc-300 shrink-0">
                  VIEWER
                </code>
                <span className="text-zinc-500 text-xs">
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <div className="rounded-2xl border border-hairline bg-white/[0.03] p-6 mb-4">
          ...
          <div className="rounded-2xl border border-dashed border-hairline-strong p-6 mb-8">
        ...
        <>
          ...
          <div className="space-y-6 mb-8">
            ...
            <div className="border-l-2 border-cyan-500 pl-6">
              ...
              <p className="text-sm text-zinc-500 leading-relaxed">
                ...
                <code className="rounded bg-white/[0.07] px-1 font-mono text-[12px] text-brand">
                  Authorization
                </code>{" "}
          ...
          <div className="space-y-6 mb-8">
            <div className="border-l-2 border-emerald-500 pl-6">
              ...
              <p className="text-sm text-zinc-500 leading-relaxed">
                Paste any <code className="rounded bg-white/[0.07] px-1 font-mono text-[12px] text-brand">curl</code>{" "}
      ...
      content: (
        <>
          <p className="text-[15px] leading-[1.75] text-zinc-400 mb-7">
            ...
            <code className="rounded bg-white/[0.07] px-1.5 py-0.5 font-mono text-[13px] text-brand">
              {"{{name}}"}
            </code>{" "}
          ...
          <div className="rounded-xl border border-hairline bg-black/50 p-6 font-mono text-[13px] leading-relaxed mb-6">
            <div className="text-zinc-500">
              <span className="text-brand">{"{{baseUrl}}"}</span>/users/
              <span className="text-brand">{"{{userId}}"}</span>
            </div>
          ...
          <ul className="space-y-3 mb-6 text-sm">
            <li className="flex items-start gap-3">
              <CheckCircle2 className="mt-0.5 h-4 w-4 shrink-0 text-method-post" strokeWidth={2} />
          ...
          <p className="text-xs text-zinc-500 leading-relaxed mb-8">
            ...
            &mdash; sending{" "}
            <code className="bg-white/[0.07] px-1 rounded text-zinc-400">https:///users</code>{" "}
          ...
          <div className="space-y-4 mb-8">
            <div className="rounded-xl border border-hairline bg-white/[0.03] p-5">
              ...
              <p className="text-xs text-zinc-500 leading-relaxed">
                ...
                <code className="bg-white/[0.07] px-1 rounded text-brand">localhost</code>,
      ...
      content: (
        <>
          ...
          <ul className="space-y-3 mb-8 text-sm">
            <li className="flex items-start gap-3">
              <CheckCircle2 className="mt-0.5 h-4 w-4 shrink-0 text-status-ok" strokeWidth={2} />
              <span className="text-zinc-500">
      ...
      content: (
        <>
          ...
          <p className="text-xs text-zinc-500 leading-relaxed mb-8">
            ...
            <code className="bg-white/[0.07] px-1 rounded text-brand">
    ...
    },
    {
      id: "collaboration",
      title: "Collaboration",
      icon: <Share2 className="h-6 w-6 text-brand" />,
      content: (
        <>
          <p className="text-[15px] leading-[1.75] text-zinc-400 mb-7">
          ...
          <div className="rounded-xl border border-hairline bg-white/[0.03] p-5 mb-6">
  ...
  return (
    <div className="space-y-24">
      {/* Intro section */}
      <section>
        <h1 className="text-balance text-[clamp(2.25rem,5vw,3.25rem)] font-semibold leading-[1.05] tracking-[-0.035em] text-white mb-6">
          Impulse Documentation
        </h1>
        <p className="text-pretty text-[17px] leading-relaxed text-zinc-400 mb-16">
      ...
      {sections.map((section) => (
        <section key={section.id} id={section.id} className="scroll-mt-24">
          <div className="mb-7 flex items-center gap-3">
            {section.icon}
            <h2 className="text-[26px] font-semibold tracking-[-0.025em] text-white">
              {section.title}
            </h2>
          </div>
      ...
      {/* Feedback section */}
      <section className="rounded-2xl border border-hairline bg-white/[0.03] p-10 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link href="https://github.com/Somilg11" target="_blank">
            <button className="rounded-full bg-brand px-7 py-2.5 text-[14px] font-medium text-white transition-colors hover:bg-brand-hover">
              Contact Developer
            </button>
          </Link>
          <Link href="https://github.com/Somilg11/impulse/issues" target="_blank">
            <button className="rounded-full border border-hairline-strong bg-white/[0.04] px-7 py-2.5 text-[14px] font-medium text-white transition-colors hover:bg-white/[0.08]">
              Report Bug
            </button>
          </Link>
        </div>
      ...
      <div className="flex items-center justify-between border-t border-hairline pt-12 text-right">
        <div />
        <Link href="#getting-started" className="group">
          ...
          <span className="text-white group-hover:text-brand font-bold flex items-center justify-end gap-2 transition-colors">
